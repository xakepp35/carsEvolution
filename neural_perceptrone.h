...
class neural_perceptrone : public competition::i_solver {
public:

	neural_perceptrone(size_t nAgents, size_t nNeurons, size_t inputWidth);
	~neural_perceptrone();
	...
	float substep_neuron_calc_dot(size_t i, size_t j) const;
	void substep_neuron_compress(size_t i, size_t j, float dotResult);
